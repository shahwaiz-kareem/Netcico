  ...
  return (
    <section className="w-full h-full py-4  rounded-lg">
      <div className={'px-6 flex flex-col  h-full justify-center  mx-auto  gap-2 ' + width}>
        <h1 className='text-2xl font-bold'>Create Blog ({currentStep.name})</h1>
        ...
        }
        {
          ...
          <div className='h-full w-[70%] m-auto mt-4 px-2 text-black bg-white rounded-lg overflow-y-scroll'>
            <Editor />
          </div>
        }
        {
          ...
          <div className='h-full flex justify-between items-center w-[80%]'>
            ...
            <div className='flex justify-center items-center  gap-4 flex-col w-[30%]'>
              <button className="inline-flex items-center w-full px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-md">
                <RiDraftLine className='h-4 w-4' />
                Save As Draft
              </button>
              <button className="inline-flex items-center w-full px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-md">
