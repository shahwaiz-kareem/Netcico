...
const Card = () => {
  return (
    ...
    <div
      className="transition-all duration-150 flex w-full px-4 my-4 md:w-1/2 lg:w-1/3 2xl:w-1/4"
    >
      <div
      ...
      >
        <Link href={"/articles/technologies which will kill nodejs in 2030"} >
        ...
        <div className="flex flex-wrap items-center flex-1 px-4  ">
        ...
        <p
          className="flex flex-row flex-wrap w-full px-4 overflow-hidden text-sm text-justify text-gray-700"
        >
          Technology is the application of knowledge for achieving practical goals in a reproducible way. The word technology can also mean the products resulting from such efforts ...
