...
const AdminLink = ({ link, Icon, text }) => {
  return (
    ...
    >
      ...
      <div
        className="bg-white/10  text-lg text-white group-hover:bg-white/5 w-[85%] group-active:scale-95 self-stretch px-4 rounded-lg   shadow flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white "
        href="#"
      >
