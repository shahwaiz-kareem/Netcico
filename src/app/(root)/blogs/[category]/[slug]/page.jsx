  ...
  return (
    <>
      <section className='flex flex-col gap-4 mt-4 w-full'>
        ...
        <article className='flex relative ml-4 gap-4'>
          <div className='border flex justify-center fixed  shadow-2xl mt-10'>
            <span className='flex flex-col border  bg-white gap-4  text-3xl rounded-md   '>
